export const DISTRIBUTIVE_LAW_SETS = {
  ...
  blocks: [
    ...
    { id: 'set1-2', latex: '\\textbf{Part 1: } A \\cap (B \\cup C) {{setop}} (A \\cap B) \\cup (A \\cap C)' },
    { id: 'set1-3', latex: '\\text{Let } x {{setop}} A {{logic}} (B {{setop}} C).' },
    { id: 'set1-4', latex: '\\text{Then } x {{setop}} A \\text{ and } x {{setop}} (B \\cup C).' },
    { id: 'set1-5', latex: '\\text{Since } x {{setop}} (B {{logic}} C) \\text{, either } x {{setop}} B \\text{ or } x {{setop}} C \\text{ (or both).}' },
    { id: 'set1-6', latex: '\\text{Case 1: If } x {{setop}} B \\text{, then since } x {{setop}} A \\text{, we have } x {{setop}} A \\cap B.' },
